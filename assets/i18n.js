...
(function () {
  ...
  var DICT = {
    ru: {
      ...
      'menu.pack.sub.step': 'пока печатается лист — запусти рыбку сразу',
    ...
    en: {
      ...
      'menu.pack.sub.step': 'while the sheet is printing — release one right away',
    ...
    pl: {
      ...
      'menu.pack.sub.step': 'póki kartka się drukuje — wypuść rybkę od razu',
