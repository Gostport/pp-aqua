...
(function () {
  ...
  var DICT = {
    ru: {
      ...
      'home.bycode.hint': 'Код нужен только на новом устройстве — на этом аквариумы запоминаются сами.',
      ...
      'home.how.s1': 'Распечатай раскраску-шаблон',
      'home.how.s2': 'Раскрась фломастерами',
      'home.how.s3': 'Сфотографируй телефоном',
      'home.how.s4': 'Смотри на большом экране',
      'home.how.need': 'Понадобятся: принтер, фломастеры и телефон с камерой.',
      ...
      'home.footer.text': ' Аккаунтов нет. По коду аквариум смотрят — его можно давать кому угодно. По паролю им управляют: меняют фон, имя, удаляют рыбок и сам аквариум. Список хранится в этом браузере, так что если почистить его данные, аквариумы найдутся только по коду, а управление — только по паролю. Сохрани и то, и другое: восстановить их негде.',
      ...
      'menu.tank': 'Аквариум',
      'menu.code': 'код',
      'menu.copy': 'Скопировать ссылку на аквариум',
      ...
      'menu.steps.title': '🫧 В аквариуме пока никого',
      'menu.steps.text': 'Распечатай раскраску → раскрась фломастерами → сфотографируй с телефона. Рыбка поплывёт здесь через пару секунд.',
      ...
      'menu.share.tv': 'Телевизор без камеры? Открой на нём этот сайт и введи код:',
      'menu.steps.qr': 'Съёмка — на телефоне: наведи камеру на этот код, и она откроется сразу.',
      'menu.print.step': '1. Распечатай раскраску',
      'menu.capture.step': '2. Сфотографируй раскрашенную рыбку',
    ...
    en: {
      ...
      'home.how.s4': 'Watch on a big screen',
      'home.how.need': 'You will need: a printer, markers and a phone with a camera.',
      ...
      'home.footer.text': ' There are no accounts. The code lets anyone watch the aquarium — share it freely. The password is what lets you manage it: change the background and name, remove fish and the aquarium itself. The list lives in this browser, so if you clear its data, aquariums can only be found by code and managed only with the password. Save both: there is nowhere to recover them from.',
      ...
      'menu.tank': 'Aquarium',
      'menu.code': 'code',
      'menu.copy': 'Copy the link to this aquarium',
      ...
      'menu.steps.title': '🫧 Nobody lives here yet',
      'menu.steps.text': 'Print a colouring sheet → colour it with markers → take a photo with your phone. The fish will be swimming here a couple of seconds later.',
      ...
      'menu.share.tv': 'A TV with no camera? Open this site on it and type the code:',
      'menu.steps.qr': 'Shooting happens on a phone: point its camera at this code and it opens right away.',
      'menu.print.step': '1. Print a colouring sheet',
      'menu.capture.step': '2. Photograph the coloured fish',
    ...
    pl: {
      ...
      'home.how.s4': 'Oglądaj na dużym ekranie',
      'home.how.need': 'Przydadzą się: drukarka, flamastry i telefon z aparatem.',
      ...
      'home.footer.text': ' Nie ma kont. Kod służy do oglądania akwarium — można go dawać każdemu. Hasło służy do zarządzania: zmiana tła i nazwy, usuwanie rybek i samego akwarium. Lista jest zapisana w tej przeglądarce, więc po wyczyszczeniu jej danych akwarium znajdziesz tylko po kodzie, a zarządzisz nim tylko hasłem. Zachowaj jedno i drugie: nie ma skąd ich odzyskać.',
      ...
      'menu.tank': 'Akwarium',
      'menu.code': 'kod',
      'menu.copy': 'Skopiuj link do akwarium',
      ...
      'menu.steps.title': '🫧 Nikogo tu jeszcze nie ma',
      'menu.steps.text': 'Wydrukuj kolorowankę → pokoloruj mazakami → zrób zdjęcie telefonem. Rybka popłynie tutaj po paru sekundach.',
      ...
      'menu.share.tv': 'Telewizor bez aparatu? Otwórz na nim tę stronę i wpisz kod:',
      'menu.steps.qr': 'Zdjęcie robi się telefonem: skieruj aparat na ten kod, a zaraz się otworzy.',
      'menu.print.step': '1. Wydrukuj kolorowankę',
      'menu.capture.step': '2. Sfotografuj pokolorowaną rybkę',
