...
(function () {
  ...
  var DICT = {
    ru: {
      ...
      'home.created.text': 'Сохрани код и пароль. По коду аквариум открывают и смотрят, по паролю им управляют. Восстановить их будет негде — ни почты, ни аккаунта тут нет.',
      ...
      'menu.home.sub': 'другие аквариумы и как открыть этот на телефоне',
    ...
    en: {
      ...
      'home.created.text': 'Save the code and the password. The code opens the aquarium for watching, the password lets you manage it. There is nowhere to recover them — no email, no account here.',
      ...
      'menu.home.sub': 'other aquariums and how to open this one on a phone',
    ...
    pl: {
      ...
      'home.created.text': 'Zachowaj kod i hasło. Kodem otwiera się akwarium do oglądania, hasłem się nim zarządza. Nie ma skąd ich odzyskać — nie ma tu ani poczty, ani konta.',
      ...
      'menu.home.sub': 'inne akwaria i jak otworzyć to na telefonie',
